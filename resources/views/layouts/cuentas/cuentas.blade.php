    ...
    <table id="grid6" class="table table-striped table-bordered" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr @if($key->estado=='activo') class="success" @else class="danger"  @endif>
                ...
                <td>
                    <a href="{{url('cuentas/'.$key->slug)}}"><button class="btn  btn-xs"><i class="fa fa-eye" aria-hidden="true"></i></button></a>
                    <a href="{{url('cuentas/'.$key->slug.'/edit')}}"><button class="btn btn-primary btn-xs"><i class="fas fa-pencil-alt"></i></button></a>
                ...
                <!-- MODALES PARA ACCIONES EN Cuentas -->
                <!-- Modal Editar -->
                    ...
                    <div class="modal-dialog" style="margin-top:10vw;">
                        ...
                        <div class="modal-content">
                            <div class="modal-body text-center">
                                <h3> &#191;Est&aacute; seguro que desea eliminar cuenta: <b><?=$key->nombre;?></b>?</h3>
                            </div>
                            <div class="modal-footer">
                                <form method="POST" action="{{url('cuentas/'.$key->slug)}}" >
                                @csrf
                                @method('DELETE')
               ...
               <!-- FIN MODAL ELIMINAR -->
               <!-- FIN DE MODALES PARA ACCIONES DE CuentaS -->
            </tr>
            @endforeach
        </tbody>
    </table>
