   ...
   <div class="modal-dialog" style="margin-top:10vw;">
      ...
      <div class="modal-content">
         <div class="modal-body text-center">
            <h3> ¿Est&aacute; seguro que desea eliminar a: <b><?=$Cuenta->nombre;?></b>?</h3>
         </div>
   ...
   <div class="modal-dialog" style="margin-top:10vw;">
      ...
      <div class="modal-content">
        <form method="POST" action="{{url('cuentas/baja')}}" >
         <div class="modal-body text-center">
            <h3> ¿Est$aacute; seguro que desea @if($Cuenta->estado!='activo') activar @else dar de baja @endif  la Cuenta: <b><?=$Cuenta->nombre;?></b>?</h3>
         @if($Cuenta->estado=='activo')
         <label>¿Raz&oacute;n por la cu&aacute;l se da de baja la Cuenta?</label>
         ...
         <div class="profile-sidebar panel panel-default">
            ...
            <div class="row ">
              <div class="col-md-12" style="margin-top:5px;">
               ...
               <button type="button" class="btn btn-success btn-xs btn-block"><i class="fas fa-pencil-alt"></i> Editar</button></a>
              </div>
              <div class="col-md-12" style="margin-top:5px;">
